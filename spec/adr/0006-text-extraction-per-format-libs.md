...
- **OPEN:** the concrete `.doc` handling approach is unresolved and must be pinned during Phase 1 — if it forces a LibreOffice/Word dependency, reconsider Apache Tika via a superseding ADR.
